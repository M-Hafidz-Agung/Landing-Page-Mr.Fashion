    ...
    if (!service) {
        return (
            <div className="pt-32 pb-20 text-center min-h-screen">
                ...
                <Link href="/services" className="text-pink-600 hover:underline mt-4 block">{t.detail.back}</Link>
            </div>
        );
    }
        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="relative h-[60vh] bg-stone-900 overflow-hidden">
                ...
                <div className="relative z-10 h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-end pb-16">
                    <Link href="/services" className="text-pink-400 hover:text-pink-300 flex items-center gap-2 mb-8 font-medium transition-colors w-fit">
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-24 space-y-8">
                            <div className="bg-stone-900 text-cream-50 p-8 rounded-2xl shadow-2xl relative overflow-hidden">
                                ...
                                <Link href="/contact" className="group block w-full py-4 bg-white text-stone-900 text-center rounded-xl font-bold hover:bg-pink-50 transition-all relative z-10 flex items-center justify-center gap-2">
                                    {t.detail.contactNow}
                            ...
                            <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm">
                                ...
                                <nav className="flex flex-col gap-3">
                                    {['production', 'supply-chain', 'sourcing'].map(s => {
                                        ...
                                        return (
                                            <Link key={s} href={`/services/${s}`} className="text-stone-600 hover:text-pink-600 font-medium transition-colors flex items-center justify-between group">
                                                {label}
